...
func _process(delta: float) -> void:
	...
	$CanvasLayer/BottomPanel/HBoxContainer/Player1/GrabLabel1.visible = main.Players[0].can_grab()
	$CanvasLayer/BottomPanel/HBoxContainer/Player1/UseLabel1.visible = main.Players[0].can_use()
	
	$CanvasLayer/BottomPanel/HBoxContainer/Player2/GrabLabel2.visible = main.Players[1].can_grab()
	$CanvasLayer/BottomPanel/HBoxContainer/Player2/UseLabel2.visible = main.Players[1].can_use()
